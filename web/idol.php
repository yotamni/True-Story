  ...
  <body>
    ...
    <main>
      <form action="javascript:searchResult();">
        <div class="input-group mb-3 col-md-8 offset-md-2 col-lg-4 offset-lg-4">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="text-center">
                      <h1 class="col-lg-12" id="idolName"></h1>
                      <div class="btn-group exploreGroupBtn" role="group" aria-label="Basic example">
                        <button type="button" id="exploreButton" onclick="exploreIdol()" class="btn btn-outline-dark">are followers robots?</button>
